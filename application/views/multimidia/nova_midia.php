...
<div class="container">
  <?=form_open_multipart('multimidia/adicionarFoto'); ?>

    <div class="form-group">
      <label for="nome"> Nome da Foto</label>
      <input type="text" class="form-control" id="nome" placeholder="Insira o nome da foto">
    </div>
    ...
    <div class="form-group">
      ...
      <textarea class="form-control" id="foto" placeholder="Digite a mensagem aqui" rows="6"> </textarea>
    </div>

    <div class="form-group">
      <label for="data">Insira a data da foto</label>
      <input type="date" class="form-control" id="data">
      <small id="fotoHelp" class="form-text text-muted">A data deve estar no fomato dd/mm/aaaa com zeros a esquerda.
        Ex:01/09/2001</small>
    </div>
